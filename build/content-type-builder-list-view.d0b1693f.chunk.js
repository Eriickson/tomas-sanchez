...
`;function z({isActive:t}){return e.createElement(ye,{alignItems:"center",background:t?"primary200":"neutral200",justifyContent:"center",isActive:t},e.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 448 512"},e.createElement("path",{d:"M216.3 2c4.8-2.6 10.5-2.6 15.3 0L422.3 106c5.1 2.8 8.3 8.2 8.3 14s-3.2 11.2-8.3 14L231.7 238c-4.8 2.6-10.5 2.6-15.3 0L25.7 134c-5.1-2.8-8.3-8.2-8.3-14s3.2-11.2 8.3-14L216.3 2zM23.7 170l176 96c5.1 2.8 8.3 8.2 8.3 14V496c0 5.6-3 10.9-7.8 13.8s-10.9 3-15.8 .3L8.3 414C3.2 411.2 0 405.9 0 400V184c0-5.6 3-10.9 7.8-13.8s10.9-3 15.8-.3zm400.7 0c5-2.7 11-2.6 15.8 .3s7.8 8.1 7.8 13.8V400c0 5.9-3.2 11.2-8.3 14l-176 96c-5 2.7-11 2.6-15.8-.3s-7.8-8.1-7.8-13.8V280c0-5.9 3.2-11.2 8.3-14l176-96z",fill:"currentColor"})))}z.defaultProps={isActive:!1},z.propTypes={isActive:o().bool};const _=(0,h.default)(n.Box)`
  position: absolute;
  display: none;
  top: 5px;
  right: ${(0,c.pxToRem)(8)};
...
`;function U({component:t,dzName:a,index:l,isActive:s,isInDevelopmentMode:p,onClick:r}){const{modifiedData:u,removeComponentFromDynamicZone:x}=(0,L.Z)(),{schema:{displayName:T}}=C()(u,["components",t],{schema:{}}),E=g=>{g.stopPropagation(),x(a,l)};return e.createElement(he,{as:"button",alignItems:"center",direction:"column",className:s?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,type:"button",onClick:r},e.createElement(z,{isActive:s}),e.createElement(n.Box,{marginTop:1,maxWidth:"100%"},e.createElement(n.Typography,{variant:"pi",fontWeight:"bold",ellipsis:!0},T)),p&&e.createElement(_,{as:"button",onClick:E,type:"button"},e.createElement(b.Cross,null)))}U.defaultProps={component:null,isActive:!1,isInDevelopmentMode:!1,onClick(){}},U.propTypes={component:o().string,dzName:o().string.isRequired,index:o().number.isRequired,isActive:o().bool,isInDevelopmentMode:o().bool,onClick:o().func};const be=U,ee=h.default.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`,ae=t=>e.createElement(Be,null,e.createElement(Ze,{width:"20",height:"23",viewBox:"0 0 20 23",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},e.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.02477 14.7513C8.65865 17.0594 11.6046 18.6059 17.5596 18.8856C18.6836 18.9384 19.5976 19.8435 19.5976 20.9688V20.9688C19.5976 22.0941 18.6841 23.0125 17.5599 22.9643C10.9409 22.6805 6.454 20.9387 3.75496 17.1258C0.937988 13.1464 0.486328 7.39309 0.486328 0.593262H4.50974C4.50974 7.54693 5.06394 11.9813 7.02477 14.7513Z"})));ae.propTypes={color:o().string.isRequired};const De=ae,j=({content:t})=>Y()(t);j.defaultProps={content:null},j.propTypes={content:o().string};const Le=j,Ie=(0,h.default)(n.Box)`
  position: relative;
`;var Fe=d(68314);const H=({type:t,customField:a,repeatable:l})=>{const{formatMessage:s}=(0,D.useIntl)();let p=t;return["integer","biginteger","float","decimal"].includes(t)?p="number":["string"].includes(t)&&(p="text"),a?e.createElement(n.Typography,null,s({id:(0,y.Z)("attribute.customField"),defaultMessage:"Custom field"})):e.createElement(n.Typography,null,s({id:(0,y.Z)(`attribute.${p}`),defaultMessage:t}),"\xA0",l&&s({id:(0,y.Z)("component.repeatable"),defaultMessage:"(repeatable)"}))};H.defaultProps={customField:null,repeatable:!1},H.propTypes={type:o().string.isRequired,customField:o().string,repeatable:o().bool};const Ae=H;function K({configurable:t,customField:a,editTarget:l,firstLoopComponentUid:s,isFromDynamicZone:p,name:r,onClick:u,relation:x,repeatable:T,secondLoopComponentUid:E,target:g,targetUid:i,type:m}){const{contentTypes:f,isInDevelopmentMode:B,removeAttribute:k}=(0,L.Z)(),{formatMessage:w}=(0,D.useIntl)(),v=m==="relation"&&x.includes("morph"),M=["integer","biginteger","float","decimal"].includes(m)?"number":m,Z=C()(f,[g],{}),I=C()(Z,["schema","displayName"],""),F=C()(Z,"plugin"),G=g?"relation":M,A=()=>{v||t!==!1&&u(l,E||s||i,r,m,a)};let R;return E&&s?R=2:s?R=1:R=0,e.createElement(Ie,{as:"tr",...(0,c.onRowClick)({fn:A,condition:B&&t&&!v})},e.createElement("td",{style:{position:"relative"}},R!==0&&e.createElement(De,{color:p?"primary200":"neutral150"}),e.createElement(n.Stack,{paddingLeft:2,spacing:4,horizontal:!0},e.createElement(Fe.Z,{type:G,customField:a}),e.createElement(n.Typography,{fontWeight:"bold"},r))),e.createElement("td",null,g?e.createElement(n.Typography,null,w({id:(0,y.Z)(`modelPage.attribute.${v?"relation-polymorphic":"relationWith"}`),defaultMessage:"Relation with"}),"\xA0",e.createElement("span",{style:{fontStyle:"italic"}},e.createElement(Le,{content:I}),"\xA0",F&&`(${w({id:(0,y.Z)("from"),defaultMessage:"from"})}: ${F})`)):e.createElement(Ae,{type:m,customField:a,repeatable:T})),e.createElement("td",null,B?e.createElement(n.Flex,{justifyContent:"flex-end",...c.stopPropagation},t?e.createElement(n.Stack,{horizontal:!0,spacing:1},!v&&e.createElement(n.IconButton,{onClick:A,label:`${w({id:"app.utils.edit",defaultMessage:"Edit"})} ${r}`,noBorder:!0,icon:e.createElement(b.Pencil,null)}),e.createElement(n.IconButton,{onClick:S=>{S.stopPropagation(),k(l,r,E||s||"")},label:`${w({id:"global.delete",defaultMessage:"Delete"})} ${r}`,noBorder:!0,icon:e.createElement(b.Trash,null)})):e.createElement(b.Lock,null)):e.createElement(n.Box,{height:(0,c.pxToRem)(32)})))}K.defaultProps={configurable:!0,customField:null,firstLoopComponentUid:null,isFromDynamicZone:!1,onClick(){},relation:"",repeatable:!1,secondLoopComponentUid:null,target:null,targetUid:null,type:null},K.propTypes={configurable:o().bool,customField:o().string,editTarget:o().string.isRequired,firstLoopComponentUid:o().string,isFromDynamicZone:o().bool,name:o().string.isRequired,onClick:o().func,relation:o().string,repeatable:o().bool,secondLoopComponentUid:o().string,target:o().string,targetUid:o().string,type:o().string};const Se=(0,e.memo)(K),Pe=t=>{let a;switch(t){case"date":case"datetime":case"time":case"timestamp":a="date";break;case"integer":case"biginteger":case"decimal":case"float":a="number";break;case"string":case"text":a="text";break;case"":a="relation";break;default:a=t}return a},Ne={collectionTypesConfigurations:[{action:"plugin::content-manager.collection-types.configure-view",subject:null}],componentsConfigurations:[{action:"plugin::content-manager.components.configure-layout",subject:null}],singleTypesConfigurations:[{action:"plugin::content-manager.single-types.configure-view",subject:null}]},X=({disabled:t,isTemporary:a,isInContentTypeView:l,contentTypeKind:s,targetUid:p})=>{const{formatMessage:r}=(0,D.useIntl)(),{push:u}=(0,N.useHistory)(),{collectionTypesConfigurations:x,componentsConfigurations:T,singleTypesConfigurations:E}=Ne,g=r({id:"content-type-builder.form.button.configure-view"});let i=x;const m=()=>(a||u(l?`/content-manager/collectionType/${p}/configurations/edit`:`/content-manager/components/${p}/configurations/edit`),!1);return l&&s==="singleType"&&(i=E),l||(i=T),e.createElement(c.CheckPermissions,{permissions:i},e.createElement(n.Button,{startIcon:e.createElement(b.Layer,null),variant:"tertiary",onClick:m,disabled:a||t},g))};X.defaultProps={contentTypeKind:"collectionType",isInContentTypeView:!0,isTemporary:!1,targetUid:""},X.propTypes={disabled:o().bool.isRequired,contentTypeKind:o().string,isInContentTypeView:o().bool,isTemporary:o().bool,targetUid:o().string};const ze=(0,e.memo)(X),Ue=()=>{const{initialData:t,modifiedData:a,isInDevelopmentMode:l,isInContentTypeView:s,submitData:p}=(0,L.Z)(),{formatMessage:r}=(0,D.useIntl)(),{trackUsage:u}=(0,c.useTracking)(),x=(0,N.useRouteMatch)("/plugins/content-type-builder/:kind/:currentUID"),{onOpenModalAddComponentsToDZ:T,onOpenModalAddField:E,onOpenModalEditField:g,onOpenModalEditSchema:i,onOpenModalEditCustomField:m}=(0,q.Z)(),f=s?"contentType":"component",B=[f,"schema","attributes"],k=C()(a,[f,"uid"]),w=C()(a,[f,"isTemporary"],!1),v=C()(a,[f,"schema","kind"],null),M=C()(a,B,[]),Z=me()(t,[f,"plugin"]),I=!Q()(a,t),F=s?"contentType":"component",G=$=>{T({dynamicZoneTarget:$,targetUid:k})},A=async($,le,re,se,ie)=>{const ce=Pe(se);ie?m({forTarget:$,targetUid:le,attributeName:re,attributeType:ce,customFieldUid:ie}):g({forTarget:$,targetUid:le,attributeName:re,attributeType:ce,step:se==="component"?"2":null})};let R=C()(a,[f,"schema","displayName"],"");const S=C()(a,[f,"schema","kind"],""),P=x?.params.currentUID==="create-content-type";!R&&P&&(R=r({id:(0,y.Z)("button.model.create"),defaultMessage:"Create new collection type"}));const We=()=>{const $=S||f;$==="collectionType"&&u("willEditNameOfContentType"),$==="singleType"&&u("willEditNameOfSingleType"),i({modalType:f,forTarget:f,targetUid:k,kind:$})};return e.createElement(e.Fragment,null,e.createElement(N.Prompt,{message:r({id:(0,y.Z)("prompt.unsaved")}),when:I}),e.createElement(n.HeaderLayout,{id:"title",primaryAction:l&&e.createElement(n.Stack,{horizontal:!0,spacing:2},!P&&e.createElement(n.Button,{startIcon:e.createElement(b.Plus,null),variant:"secondary",onClick:()=>{E({forTarget:F,targetUid:k})}},r({id:(0,y.Z)("button.attributes.add.another")})),e.createElement(n.Button,{startIcon:e.createElement(b.Check,null),onClick:()=>p(),type:"submit",disabled:Q()(a,t)},r({id:"global.save",defaultMessage:"Save"}))),secondaryAction:l&&!Z&&!P&&e.createElement(n.Button,{startIcon:e.createElement(b.Pencil,null),variant:"tertiary",onClick:We},r({id:"app.utils.edit",defaultMessage:"Edit"})),title:Y()(R),subtitle:r({id:(0,y.Z)("listView.headerLayout.description"),defaultMessage:"Build the data architecture of your content"}),navigationAction:e.createElement(c.Link,{startIcon:e.createElement(b.ArrowLeft,null),to:"/plugins/content-type-builder/"},r({id:"global.back",defaultMessage:"Back"}))}),e.createElement(n.ContentLayout,null,e.createElement(n.Stack,{spacing:4},e.createElement(n.Flex,{justifyContent:"flex-end"},e.createElement(n.Stack,{horizontal:!0,spacing:2},e.createElement(ze,{key:"link-to-cm-settings-view",targetUid:k,isTemporary:w,isInContentTypeView:s,contentTypeKind:v,disabled:P}))),e.createElement(n.Box,{background:"neutral0",shadow:"filterShadow",hasRadius:!0},e.createElement(oe,{items:M,customRowComponent:$=>e.createElement(Se,{...$,onClick:A}),addComponentToDZ:G,targetUid:k,editTarget:F,isMain:!0})))))}}}]);
